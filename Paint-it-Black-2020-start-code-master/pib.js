...
let jsonObj = "";
let ega = ["#000000", "#0000aa", "#00aa00",
"#00aaaa", "#aa0000", "#aa00aa", "#aa5500",
"#aaaaaa", "#ffffff", "#5555ff", "#55ff55",
...
function readJson(jsonString) {
  jsonObj = JSON.parse(jsonString); //JSON.parse zet java data om in JSON data
  for (i = 0; i < 80; i++){
